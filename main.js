...
const createCompany = async (url, token, method) => {
   ...
   const requestForCreateCompany = {
      ...
      numberofemployees: document.querySelector('#fieldsForCompany').querySelector(".numberOfWorkers").value.match(/\d+/g)[0],
...
const updateExistedTableForEditableFields = async (elements, elementsMain, existedInputs, existedData) => {
   ...
   console.log(existedInputs,'locationlocationlocation',existedData)
